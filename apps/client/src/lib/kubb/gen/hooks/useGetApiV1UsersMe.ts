...
export const getApiV1UsersMeQueryKey = () => [{ url: '/api/v1/users/@me' }] as const

export type GetApiV1UsersMeQueryKey = ReturnType<typeof getApiV1UsersMeQueryKey>
...
export function useGetApiV1UsersMe<TData = GetApiV1UsersMeQueryResponse, TQueryData = GetApiV1UsersMeQueryResponse, TQueryKey extends QueryKey = GetApiV1UsersMeQueryKey>(options: 
{
 ...
 = {}) {
         ...
         const queryKey = resolvedOptions?.queryKey ?? getApiV1UsersMeQueryKey()
