...
export type postApiV1ReadingsJourneyNextResponseError = (postApiV1ReadingsJourneyNextResponse400 | postApiV1ReadingsJourneyNextResponse401 | postApiV1ReadingsJourneyNextResponse404 | postApiV1ReadingsJourneyNextResponse409 | postApiV1ReadingsJourneyNextResponse500) & {
  headers: Headers;
};
 ...
 */
export const postApiV1ReadingsJourneyNext = async (postApiV1ReadingsJourneyNextBody?: PostApiV1ReadingsJourneyNextBody, options?: RequestInit): Promise<postApiV1ReadingsJourneyNextResponse> => {
...
export const getPostApiV1ReadingsJourneyNextMutationOptions = <TError = ApiErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiV1ReadingsJourneyNext>>, TError,{data?: PostApiV1ReadingsJourneyNextBody}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof postApiV1ReadingsJourneyNext>>, TError,{data?: PostApiV1ReadingsJourneyNextBody}, TContext> => {
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiV1ReadingsJourneyNext>>, {data?: PostApiV1ReadingsJourneyNextBody}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiV1ReadingsJourneyNextMutationBody = PostApiV1ReadingsJourneyNextBody | undefined
