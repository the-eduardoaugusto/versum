...
export type putApiV1ProfilesMePictureResponseSuccess =
  putApiV1ProfilesMePictureResponse200 & {
    headers: Headers;
  };
export type putApiV1ProfilesMePictureResponseError = (
  | putApiV1ProfilesMePictureResponse400
  | putApiV1ProfilesMePictureResponse401
  | putApiV1ProfilesMePictureResponse403
  | putApiV1ProfilesMePictureResponse404
  | putApiV1ProfilesMePictureResponse413
  | putApiV1ProfilesMePictureResponse429
  | putApiV1ProfilesMePictureResponse500
) & {
  headers: Headers;
};

export type putApiV1ProfilesMePictureResponse =
  | putApiV1ProfilesMePictureResponseSuccess
  | putApiV1ProfilesMePictureResponseError;
...
export const putApiV1ProfilesMePicture = async (
  ...
  options?: RequestInit,
): Promise<putApiV1ProfilesMePictureResponse> => {
  ...
  const data: putApiV1ProfilesMePictureResponse["data"] = body
    ? JSON.parse(body)
    : {};
  return {
    data,
    status: res.status,
    headers: res.headers,
  } as putApiV1ProfilesMePictureResponse;
};

export const getPutApiV1ProfilesMePictureMutationOptions = <
  TError = ApiErrorResponse,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PutApiV1ProfilesMePictureMutationResult = NonNullable<
  Awaited<ReturnType<typeof putApiV1ProfilesMePicture>>
>;
 ...
 * @summary Atualizar foto de perfil
 */
export const usePutApiV1ProfilesMePicture = <
  TError = ApiErrorResponse,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getPutApiV1ProfilesMePictureMutationOptions(options),
    queryClient,
  );
};
