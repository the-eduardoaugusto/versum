...
export const getApiV1ReadingsJourneyFeed = async (
  params?: GetApiV1ReadingsJourneyFeedParams,
  options?: RequestInit,
): Promise<JourneyFeedResponse> => {
  return getApiV1ReadingsJourneyFeedMutator<JourneyFeedResponse>(
    getGetApiV1ReadingsJourneyFeedUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getApiV1ReadingsJourneyStatus = async (
  ...
  return getApiV1ReadingsJourneyStatusMutator<JourneyStatusResponse>(
    getGetApiV1ReadingsJourneyStatusUrl(),
    {
      ...options,
      method: "GET",
    },
