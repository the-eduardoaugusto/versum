 ...
 */
export const putApiV1ProfilesMePicture = async (uploadProfilePictureBody: UploadProfilePictureBody, options?: RequestInit): Promise<UpdateProfilePictureResponse> => {
    const formData = new FormData();
if(uploadProfilePictureBody.file !== undefined) {
 formData.append(`file`, uploadProfilePictureBody.file);
 }

  return putApiV1ProfilesMePictureMutator<UpdateProfilePictureResponse>(getPutApiV1ProfilesMePictureUrl(),
  {
    ...options,
    method: 'PUT'
    ,
