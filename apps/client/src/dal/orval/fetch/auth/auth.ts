...
export const postApiV1AuthMagicLink = async (
  ...
  return postApiV1AuthMagicLinkMutator<SendMagicLinkResponse>(
    getPostApiV1AuthMagicLinkUrl(),
    {
      ...options,
      method: "POST",
...
export const getApiV1AuthMagicLink = async (
  params: GetApiV1AuthMagicLinkParams,
  options?: RequestInit,
): Promise<AuthenticateWithMagicLinkResponse> => {
  return getApiV1AuthMagicLinkMutator<AuthenticateWithMagicLinkResponse>(
    getGetApiV1AuthMagicLinkUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const postApiV1AuthLogout = async (
  ...
  return postApiV1AuthLogoutMutator<LogoutResponse>(
